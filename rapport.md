...
- **Preuves** : photos dans le dossier `assets/proofs/` (voir `README.md`).
...
![Liste](assets\screenshots\liste.png)

**Écran 2 – Détail d’un membre (Awa)**  
![Détail membre](assets\screenshots\detail_membre.png)

**Écran 3 – Formulaire d’ajout**  
![Formulaire](assets\screenshots\formulaire.png)

**Écran 4 – A propos**  
![Formulaire](assets\screenshots\a_propos.png)
